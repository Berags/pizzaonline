...
<div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16">
  ...
  <div class="col-start-1 row-start-2 px-4 sm:pb-16">
    ...
    <div class="flex items-center text-sm font-medium my-2 sm:mt-2 sm:mb-4">
      <span style="text-align: justify;text-justify: inter-word;">Benvenuti nella Pizzeria <b>"I Tre Porcellini"</b>. Dal <b>1963</b> la nostra pizzeria sforna <i>ogni giorno</i> dalle 100 alle 200 pizze di <i>ogni tipo</i>. 
      ...
      <br><b>Buona pizza!</b></span>
    </div>
    <hr class="w-16 border-gray-300 hidden sm:block">
  </div>
  <div class="col-start-1 row-start-3 space-y-3 px-4">
    <a class="cursor-pointer w-1/3 h-8 flex items-center justify-center rounded-full bg-purple-700 text-white">Ordina</a>
  </div>
